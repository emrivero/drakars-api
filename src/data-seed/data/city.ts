import { CityEntity } from '../../city/infrastructure/persistence/entity/city.entity';

type DataCities = Omit<CityEntity, 'id' | 'createdAt' | 'updatedAt'>;
export const dataCities: DataCities[] = [
